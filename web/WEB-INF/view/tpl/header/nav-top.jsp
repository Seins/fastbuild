...
<div class="fast-build-nav fast-build-nav-top">
    <a href="#" class="fast-build-menu-heading"><img src="${pageContext.request.contextPath}/resources/images/cloud-check-32.png" >Fast Build Component</a>
    <ul class="fast-build-menu fast-build-menu-horizontal fast-build-menu-fixed fast-build-menu-right">
        ...
        <li><a href="#"> 组件</a></li>
        <li><a href="#"> 关于</a></li>
        <li><input style="margin: 20px auto;" type="button" class="btn" id="sign" value="Login" onclick="pop('loginPop')"/></li>
    </ul>
</div>
